function [ allName, Sequence ] = TS_presentation(ppath, t, S, condition, mixed )
% 6 targets after cues (out of 10)
% 18 targets in the repetition sites (out of 30 sites)


if isequal(condition, [1,1])    % visual-targetset1, aud counter balancing the target/distractors
    output='Visual/';
    folder1='Condition1';
    folder2='Condition2';
    append='/*.jpg';
...
distractorPresLocation=datasample(11:length(allName)+k, distractorAppearance, 'Replace', true);
    for i=1:N
